...
#define SCOPE_OCG_CUSTOM (SCOPE_OCG | SCOPE_CUSTOM)
#define SCOPE_TCG_CUSTOM (SCOPE_TCG | SCOPE_CUSTOM)
#define SCOPE_OCG_TCG_CUSTOM (SCOPE_OCG | SCOPE_TCG | SCOPE_CUSTOM)
#define SCOPE_PRERELEASE_CUSTOM (SCOPE_OCG | SCOPE_TCG | SCOPE_CUSTOM | SCOPE_PRERELEASE)
